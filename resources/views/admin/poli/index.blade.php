<x-layouts.app title="Kelola Poli">
    <!-- Content Header -->
                            ...
                            @forelse($polis as $index => $poli)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('polis.destroy', $poli) }}" method="POST" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus poli ini?')">
                                            @csrf
                                            @method('DELETE')
