<x-layouts.app title="Periksa Pasien">
                    ...
                    <form action="{{ route('periksa-pasien.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="catatan" id="catatan" class="form-control" rows="3" placeholder="Catatan pemeriksaan...">{{ old('catatan') }}</textarea>
                            </div>

                            {{-- Obat terpilih --}}
                            <div class="form-group mb-3">
                                <label>Obat Terpilih</label>
                                <ul id="list-obat" class="list-group mb-2"></ul>
    ...
    <script>
        ...
        const listObat = document.getElementById('list-obat');
        const inputBiaya = document.getElementById('biaya_periksa');
        const totalBiayaP = document.getElementById('total-harga');
        ...
        function renderObat() {
            ...
            totalBiayaP.textContent = 'Rp ' + total.toLocaleString();
